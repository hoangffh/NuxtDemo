<template>
  ...
  >
    <div
      class="flex items-center justify-center flex-col p-4 w-[400px] h-[438px] rounded-lg bg-white"
    >
      <p class="font-bold text-2xl">LOGIN</p>
      <a-form
        :model="formState"
        name="normal_login"
        class="login-form w-full px-8"
        @finish="onFinish"
        ...
        <a-form-item>
          <a-row justify="center">
            <a-button
              ...
              type="primary"
              html-type="submit"
              class="login-form-button w-2/4 rounded-lg h-8"
              :loading="isLoading"
            >
              Log in
            </a-button>
